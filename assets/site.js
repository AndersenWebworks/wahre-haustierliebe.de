var staticPageRoutes = {
  ...
  "hunde-hofhaltung-und-zwinger": "/hunde/hofhaltung-und-zwinger/index.html",
  "hunde-gesundheit": "/hunde/gesundheit/index.html",
  "hunde-entscheidung": "/hunde/entscheidung/index.html",
  "katzen-sozialverhalten": "/katzen/sozialverhalten/index.html",
  "katzen-wohnungshaltung": "/katzen/wohnungshaltung/index.html",
  "katzen-kastration": "/katzen/kastration/index.html",
  "katzen-stilles-leiden": "/katzen/stilles-leiden/index.html",
  ...
  "kleintiere-degus-und-chinchillas": "/kleintiere/degus-chinchillas/index.html",
  "exoten-reptilien": "/exoten/reptilien/index.html",
  "exoten-schildkroeten": "/exoten/schildkroeten/index.html",
  "exoten-fische": "/exoten/fische/index.html",
  "pferde-herde": "/pferde/herde/index.html",
  "pferde-platzbedarf": "/pferde/platzbedarf/index.html",
  "pferde-haltungsformen": "/pferde/haltungsformen/index.html",
  "pferde-kosten": "/pferde/kosten/index.html",
  "pferde-reitbeteiligung": "/pferde/reitbeteiligung/index.html",
  "pferde-entscheidung": "/pferde/entscheidung/index.html",
  ...
  "notfallplan-haustier": "/notfallplan-haustier/index.html",
...
var staticSiteSearchIndex = [
  ...
  },
  {
    ...
    "terms": "Versorgung eines Haustiers bei plötzlichem Ausfall der Halterperson vorbereiten notfallplan-haustier notfallplan haustier"
  },
  {
    "id": "hitzefalle-auto",
...
function normalizeAssetUrls(root) {
  Array.from((root || document).querySelectorAll('img[src^="assets/"]')).forEach(function(img) {
    ...
    var articleHeroImages = {
      ...
      'notfallplan-haustier': { src: 'assets/images/cat-carrier-square.jpg', alt: 'Katze sitzt in einer Transporttasche, die für einen Notfall bereitsteht', position: 'center 20%', caption: 'Vorsorge beginnt, bevor jemand anderes übernehmen muss.', purpose: 'Notfallplan-Seite: vorbereitete Versorgung, Zugang und Transport sichtbar machen', shareReason: 'Das Bild soll dazu bewegen, den eigenen Plan heute mit der Betreuungsperson zu prüfen.' },
    ...
    var staticPageSlugs = {
      ...
      'hunde-hofhaltung-und-zwinger': 'hunde/hofhaltung-und-zwinger/',
      'hunde-gesundheit': 'hunde/gesundheit/',
      'hunde-entscheidung': 'hunde/entscheidung/',
      'hund-im-buero': 'hunde/hund-im-buero/',
      'katzen': 'katzen/',
      'katzen-sozialverhalten': 'katzen/sozialverhalten/',
      'katzen-wohnungshaltung': 'katzen/wohnungshaltung/',
      'katzen-kastration': 'katzen/kastration/',
      'katzen-stilles-leiden': 'katzen/stilles-leiden/',
      'katzen-kosten': 'katzen/kosten/',
      'katzen-streunerkatzen': 'katzen/streunerkatzen/',
      'katzen-entscheidung': 'katzen/entscheidung/',
      'wildkatzenbaby-gefunden': 'katzen/wildkatzenbaby-gefunden/',
      'voegel': 'voegel/',
      'voegel-schwarmhaltung': 'voegel/schwarmhaltung/',
      'voegel-uv-licht': 'voegel/uv-licht/',
      'voegel-kuechenluft-und-daempfe-sind-lebensgefahr': 'voegel/kuechenluft-teflon/',
      'voegel-freiflug-ist-nicht-optional': 'voegel/freiflug/',
      'voegel-partnerersatz': 'voegel/partnerersatz/',
      'voegel-krankheit-erkennen': 'voegel/krankheit-erkennen/',
      'voegel-qualzucht': 'voegel/qualzucht/',
      ...
      'kleintiere-degus-und-chinchillas': 'kleintiere/degus-chinchillas/',
      'exoten': 'exoten/',
      'exoten-reptilien': 'exoten/reptilien/',
      'exoten-schildkroeten': 'exoten/schildkroeten/',
      'exoten-fische': 'exoten/fische/',
      'pferde': 'pferde/',
      'pferde-herde': 'pferde/herde/',
      'pferde-platzbedarf': 'pferde/platzbedarf/',
      'pferde-haltungsformen': 'pferde/haltungsformen/',
      'pferde-kosten': 'pferde/kosten/',
      'pferde-reitbeteiligung': 'pferde/reitbeteiligung/',
      'pferde-entscheidung': 'pferde/entscheidung/',
