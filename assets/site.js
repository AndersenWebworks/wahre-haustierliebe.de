...
function normalizeAssetUrls(root) {
  Array.from((root || document).querySelectorAll('img[src^="assets/"]')).forEach(function(img) {
    ...
    var articleHeroImages = {
      'mensch': { src: 'assets/images/shelter-volunteer-dog-care.jpg', alt: 'Freiwillige im Tierheim kümmern sich ruhig um einen Hund', position: 'center 50%', caption: 'Der Wunsch nach Nähe braucht vorher einen ehrlichen Realitätscheck.', purpose: 'Mensch-Seite: Verantwortung und Beziehung statt Wunschbild zeigen', shareReason: 'Das Bild soll den Satz stützen: Vor einem Tier kommt die ehrliche Entscheidung.' },
      'hunde': { src: 'assets/images/dog-training-dovedale.jpg', alt: 'Hundetraining im Freien als Bild für Alltag, Zeit und Beziehung', position: 'center 48%', caption: 'Hunde brauchen Zeit, Beziehung und Alltag, nicht nur Auslauf.', purpose: 'Hunde-Seite: Alltag und Training als echte Hundehaltung zeigen', shareReason: 'Der Share-Impuls soll vom Wunschhund zur Zeitrechnung führen.' },
      ...
      'notfall': { src: 'assets/images/dog-veterinary-clinic.jpg', alt: 'Hund in einer Tierarztpraxis als ruhiges Bild für rechtzeitige Hilfe', position: 'center 50%', caption: 'Im Zweifel ruhig bleiben, anrufen, hinfahren.', purpose: 'Notfall-Seite: ruhige Handlungsfähigkeit statt Panik zeigen', shareReason: 'Das Bild soll Hemmung senken, früh tierärztliche Hilfe zu holen.' },
        ...
        },
        {
          ...
          html: `<div class="article-rhythm article-split image-context-card" data-enhancement="wissen-evidenz" data-image-purpose="Wissen-Seite: evidenzbasierte Tiermedizin als konkreter Ausweg statt Globuli zeigen" data-share-reason="Das Bild soll den Schritt weg vom Glauben und hin zur Untersuchung sichtbar machen.">
            <figure style="--image-position:center 45%;">
              <img src="assets/images/cat-vet-checkup.jpg" alt="Katze wird in einer Tierarztpraxis untersucht" loading="lazy">
